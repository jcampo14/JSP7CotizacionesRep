...
<meta name="formName" content="com.aspsols.cotizaciones.reportes.informeDeVentasPorArticuloParamForm"/>

<jsp:include page="../../../../../resources/stylesReports.html"></jsp:include>

<title>informeDeVentasPorArticuloParamForm</title>

</head>
<body>
<f:view>
<jforms:gwtscript route="../../../../../gwt24/gwt24.nocache.js" />
	<jforms:desktop width="440" height="335">
		<jforms:desktopContainer height="335">
			<jforms:frame bindsTo="frame" width="440" height="335" left="0" cssStyle="frame" backgroundColor="bfbfbf" heightUnit="px" widthUnit="px">
				<jforms:toolbarPanel bindsTo="toolbar" backgroundColor="bfbfbf" toolbarPosition="Horizontal" width="440" height="60" cssStyle="toolbar-panel">
				...
				<jforms:mainPanel bindsTo="panel0" width="440" height="335"  cssStyle="main-panel" backgroundColor="bfbfbf" overflow="Hidden">
				...
				<jforms:stackedPanel bindsTo="panel1" width="440" height="345" left="0" top="0" cssStyle="main-panel" backgroundColor="bfbfbf" viewPortWidth="440" viewPortHeight="335" showScrollbar="false" overflow="Hidden" visible="true" positionType="absolute">
	                ...
	                <jforms:textGraphic bindsTo="panel1.G_periodo_fin" height="20" width="87" left="100" cssStyle="" top="110" fill="false" fillColor="ffffff" font="Courier New,0,12" fontColor="000000" text="periodo_fin"/>
	                <jforms:textGraphic bindsTo="panel1.G_periodo_ini" height="20" width="87" left="100" cssStyle="" top="140" fill="false" fillColor="ffffff" font="Courier New,0,12" fontColor="000000" text="periodo_ini"/>
	                <jforms:textGraphic bindsTo="panel1.G_empresa" height="20" width="59" left="100" cssStyle="" top="170" fill="false" fillColor="ffffff" font="Courier New,0,12" fontColor="000000" text="empresa"/>
						                <jforms:textField bindsTo="DATA.PF_periodo_fin" height="20" width="120" top="110" left="202" backgroundColor="ffffff" foregroundColor="000000" maxSize="20" placeHolder="null" echoChar="null" helpList="" tooltip="null" prompt="null" promptDistance="2,4" promptPosition="left" promptDisplayStyle="AllRecords" promptBackground="000000" promptForeground="000000" promptOpaque="false" nOfRecDisplayed="1" recordDistance="0" formatMask="null" promptCssStyle="null" caseRestriction="Normal" horizontalAlignment="Alg_Left" keyboardNavigable="true" mouseNavigable="true" cssStyle="" cursorStyle="Normal" visible="true" editable="true" enabled="true" validateFromList="false" htmlTooltip="null">
						<jforms:font family="Arial" style="0" size="12"/>
						<jforms:promptFont family="Arial" style="0" size="12"/>
					</jforms:textField>
	                <jforms:textField bindsTo="DATA.PF_periodo_ini" height="20" width="120" top="140" left="202" backgroundColor="ffffff" foregroundColor="000000" maxSize="20" placeHolder="null" echoChar="null" helpList="" tooltip="null" prompt="null" promptDistance="2,4" promptPosition="left" promptDisplayStyle="AllRecords" promptBackground="000000" promptForeground="000000" promptOpaque="false" nOfRecDisplayed="1" recordDistance="0" formatMask="null" promptCssStyle="null" caseRestriction="Normal" horizontalAlignment="Alg_Left" keyboardNavigable="true" mouseNavigable="true" cssStyle="" cursorStyle="Normal" visible="true" editable="true" enabled="true" validateFromList="false" htmlTooltip="null">
						<jforms:font family="Arial" style="0" size="12"/>
						<jforms:promptFont family="Arial" style="0" size="12"/>
					</jforms:textField>
	                <jforms:textField bindsTo="DATA.PF_empresa" height="20" width="120" top="170" left="202" backgroundColor="ffffff" foregroundColor="000000" maxSize="" placeHolder="null" echoChar="null" helpList="" tooltip="null" prompt="null" promptDistance="2,4" promptPosition="left" promptDisplayStyle="AllRecords" promptBackground="000000" promptForeground="000000" promptOpaque="false" nOfRecDisplayed="1" recordDistance="0" formatMask="null" promptCssStyle="null" caseRestriction="Normal" horizontalAlignment="Alg_Left" keyboardNavigable="true" mouseNavigable="true" cssStyle="" cursorStyle="Normal" visible="true" editable="true" enabled="true" validateFromList="false" htmlTooltip="null">
						<jforms:font family="Arial" style="0" size="12"/>
						<jforms:promptFont family="Arial" style="0" size="12"/>
					</jforms:textField>
				</jforms:stackedPanel>
...
<jforms:statusBar top="315" width="440" showStatusBar="true"/>
</f:view>
</body>
</html>
</jsp:root>