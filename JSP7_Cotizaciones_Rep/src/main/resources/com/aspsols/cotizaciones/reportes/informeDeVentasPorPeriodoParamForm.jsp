...
<title>informeDeVentasPorPeriodoParamForm</title>

</head>
<body>
<f:view>
<jforms:gwtscript route="../../../../../gwt24/gwt24.nocache.js" />
	<jforms:desktop width="432" height="263">
		<jforms:desktopContainer height="263">
			<jforms:frame bindsTo="frame" width="432" height="263" left="0" cssStyle="frame" backgroundColor="bfbfbf" heightUnit="px" widthUnit="px">
				...
				<jforms:mainPanel bindsTo="panel0" width="432" height="263"  cssStyle="main-panel" backgroundColor="bfbfbf" overflow="Hidden">
				...
				<jforms:stackedPanel bindsTo="panel1" width="432" height="273" left="0" top="0" cssStyle="main-panel" backgroundColor="bfbfbf" viewPortWidth="432" viewPortHeight="263" showScrollbar="false" overflow="Hidden" visible="true" positionType="absolute">
	                ...
	                <jforms:textGraphic bindsTo="panel1.G_periodo" height="20" width="59" left="108" cssStyle="" top="148" fill="false" fillColor="ffffff" font="Courier New,0,12" fontColor="000000" text="Periodo"/>
	                <jforms:textGraphic bindsTo="panel1.TEXT_GRAPHIC0" height="20" width="59" left="110" cssStyle="" top="114" fill="false" fillColor="ffffff" font="Courier New,0,12" fontColor="000000" text="Empresa"/>
						                <jforms:textField bindsTo="DATA.PF_periodo" height="20" width="120" top="146" left="174" backgroundColor="ffffff" foregroundColor="000000" maxSize="20" placeHolder="(YYYY/MM)" echoChar="null" helpList="" tooltip="(YYYY/MM)" prompt="null" promptDistance="2,4" promptPosition="left" promptDisplayStyle="AllRecords" promptBackground="000000" promptForeground="000000" promptOpaque="false" nOfRecDisplayed="1" recordDistance="0" formatMask="null" promptCssStyle="null" caseRestriction="Normal" horizontalAlignment="Alg_Left" keyboardNavigable="true" mouseNavigable="true" cssStyle="" cursorStyle="Normal" visible="true" editable="true" enabled="true" validateFromList="false" htmlTooltip="null">
						<jforms:font family="Arial" style="0" size="12"/>
						<jforms:promptFont family="Arial" style="0" size="12"/>
					</jforms:textField>
...
<jforms:statusBar top="243" width="432" showStatusBar="true"/>
</f:view>
</body>
</html>
</jsp:root>