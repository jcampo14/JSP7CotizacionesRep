...
public class TOOLBAR_informeDeVentasPorEmpresaParamForm extends ApplicationDataServer implements IAcceptJForm {
	/**
	 * default serial ID. 
	 */
	...
	public TOOLBAR_informeDeVentasPorEmpresaParamForm (){
	}
