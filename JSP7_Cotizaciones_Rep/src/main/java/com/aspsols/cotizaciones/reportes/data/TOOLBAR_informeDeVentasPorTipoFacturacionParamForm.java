...
public class TOOLBAR_informeDeVentasPorTipoFacturacionParamForm extends ApplicationDataServer implements IAcceptJForm {
	/**
	 * default serial ID. 
	 */
	...
	public TOOLBAR_informeDeVentasPorTipoFacturacionParamForm (){
	}
