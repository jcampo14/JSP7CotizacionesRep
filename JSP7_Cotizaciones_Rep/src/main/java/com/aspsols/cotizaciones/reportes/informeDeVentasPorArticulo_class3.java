...
public class informeDeVentasPorArticulo_class3 extends informeDeVentasPorArticulo_class2 {
	protected ReportText reportTextMainBodyT_per_ct = new ReportText("t_PER_CT",239,15,reportRegionMainBody,10,reportFrameMainBodyFrame1,"Periodo de venta",10,50,new Color(255,255,255),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_mon = new ReportText("t_MON",289,15,reportRegionMainBody,9,reportFrameMainBodyFrame1,"Moneda",10,48,new Color(255,255,255),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_ventas = new ReportText("t_VENTAS",337,15,reportRegionMainBody,13,reportFrameMainBodyFrame1,"Ventas",10,58,new Color(255,255,255),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_cod = new ReportText("t_COD",16,15,reportRegionMainBody,12,reportFrameMainBodyFrame1,"Codigo Art",10,54,new Color(255,255,255),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_nom = new ReportText("t_NOM",70,15,reportRegionMainBody,11,reportFrameMainBodyFrame1,"Nombre",10,169,new Color(255,255,255),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
