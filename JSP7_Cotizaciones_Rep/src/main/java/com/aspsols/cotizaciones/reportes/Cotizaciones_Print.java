...
public class Cotizaciones_Print extends Cotizaciones_Print_class3 {
	...
	protected ReportFieldPresentation fieldPresentationMainBodyTiempo_entrega = new ReportFieldPresentation("TIEMPO_ENTREGA",458,195,12,90,reportRegionMainBody,77,reportFrameMainBodyEncabezado_cot,"FIXED","FIXED","TIEMPO_ENTREGA","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyNom_cargo = new ReportFieldPresentation("NOM_CARGO",375,207,12,173,reportRegionMainBody,79,repetitiveFrameMainBodyNombres_cargos,"FIXED","FIXED","NOMBRE_CARGO","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyTermino_pago = new ReportFieldPresentation("TERMINO_PAGO",191,231,11,357,reportRegionMainBody,127,reportFrameMainBodyTermino_pago_frame,"FIXED","VARIABLE","TERMINO_PAGO","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	...
	protected ReportFieldPresentation fieldPresentationMainBodySt_cod = new ReportFieldPresentation("ST_COD",20,431,9,63,reportRegionMainBody,91,repetitiveFrameMainBodySt_detalle,"FIXED","EXPAND","COD","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,7),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyNombre_cliente = new ReportFieldPresentation("NOMBRE_CLIENTE",20,48,12,237,reportRegionMainBody,99,reportFrameMainBodyDatos_cliente,"FIXED","EXPAND","NOMBRE_CLIENTE","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",1,10),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyDir_cliente = new ReportFieldPresentation("DIR_CLIENTE",20,84,12,237,reportRegionMainBody,101,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","DIR_CLIENTE","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,"DIR_CLIENTE_formatEvent",0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyTel_cliente = new ReportFieldPresentation("TEL_CLIENTE",20,96,12,237,reportRegionMainBody,102,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","TEL_CLIENTE","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,"TEL_CLIENTE_formatEvent",0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyEmail_cliente = new ReportFieldPresentation("EMAIL_CLIENTE",20,108,12,237,reportRegionMainBody,103,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","EMAIL_CLIENTE","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,"EMAIL_CLIENTE_formatEvent",0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyUbicacion_cliente = new ReportFieldPresentation("UBICACION_CLIENTE",20,120,12,237,reportRegionMainBody,104,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","UBICACION_CLIENTE","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",0,10),null,"DEFAULT",false,false,false,false,null,0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyPersona_cargo = new ReportFieldPresentation("PERSONA_CARGO",20,60,12,237,reportRegionMainBody,106,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","PER_CARGO","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",1,10),null,"DEFAULT",false,false,false,false,"PERSONA_CARGO_formatEvent",0,false,-1);
	protected ReportFieldPresentation fieldPresentationMainBodyCargo = new ReportFieldPresentation("CARGO",20,72,12,237,reportRegionMainBody,107,reportFrameMainBodyDatos_cliente,"FIXED","VARIABLE","CARGO","java.lang.String",true,0,new Color(255,255,255),null,2,new Color(0,0,0),new Font("Arial",1,10),null,"DEFAULT",false,false,false,false,"CARGO_formatEvent",0,false,-1);
