...
public class informeDeVentasPorPeriodo_class3 extends informeDeVentasPorPeriodo_class2 {
	protected ReportText reportTextMainBodyCompania = new ReportText("COMPANIA",22,10,reportRegionMainBody,4,repetitiveFrameMainBodyRepeating_frame0,"Ventas facturadas por Solagro",10,105,new Color(0,0,0),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,7),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_ventas_pas = new ReportText("t_VENTAS_PAS",302,0,reportRegionMainBody,9,reportFrameMainBodyFrame1,"Ventas a Mes (&MES) &PERIODO_PAS",10,117,new Color(255,255,255),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyC_emp = new ReportText("C_EMP",22,0,reportRegionMainBody,10,reportFrameMainBodyFrame1,"COMPAÑIA",10,105,new Color(255,255,255),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_ventas_act = new ReportText("t_VENTAS_ACT",185,0,reportRegionMainBody,11,reportFrameMainBodyFrame1,"Ventas a Mes (&MES) &PERIODO_PRE",10,117,new Color(255,255,255),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_moneda = new ReportText("t_MONEDA",127,0,reportRegionMainBody,12,reportFrameMainBodyFrame1,"Moneda",10,58,new Color(255,255,255),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyPorcentaje = new ReportText("PORCENTAJE",419,0,reportRegionMainBody,8,reportFrameMainBodyFrame1,"%",10,89,new Color(255,255,255),new Color(255,255,255),"Default,1,(0,0,0)",new Font("Arial",1,8),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
