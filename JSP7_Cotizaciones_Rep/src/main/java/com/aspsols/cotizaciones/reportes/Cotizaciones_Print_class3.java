...
public class Cotizaciones_Print_class3 extends Cotizaciones_Print_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic29 = new ReportText("TEXT_GRAPHIC29",22,643,reportRegionMainBody,74,reportFrameMainBodyFirma,"Comercial",10,255,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
