...
public class Cotizaciones_Print_class3 extends Cotizaciones_Print_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic28 = new ReportText("TEXT_GRAPHIC28",115,231,reportRegionMainBody,127,reportFrameMainBodyTermino_pago_frame,"Payment terms:",11,76,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic27 = new ReportText("TEXT_GRAPHIC27",20,231,reportRegionMainBody,128,reportFrameMainBodyTermino_pago_frame,"Términos de pago /",11,95,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic15 = new ReportText("TEXT_GRAPHIC15",83,382,reportRegionMainBody,32,reportFrameMainBodyDetalle_frame,"Nombre Artículo",9,185,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyTcod = new ReportText("tCod",20,382,reportRegionMainBody,34,reportFrameMainBodyDetalle_frame,"Código",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic45 = new ReportText("TEXT_GRAPHIC45",148,295,reportRegionMainBody,114,reportFrameMainBodyDesc_det_frame,"Nombre Artículo",11,387,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic44 = new ReportText("TEXT_GRAPHIC44",50,295,reportRegionMainBody,113,reportFrameMainBodyDesc_det_frame,"Unidad",11,44,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic48 = new ReportText("TEXT_GRAPHIC48",148,306,reportRegionMainBody,115,reportFrameMainBodyDesc_det_frame,"Item Name",11,387,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic43 = new ReportText("TEXT_GRAPHIC43",94,295,reportRegionMainBody,112,reportFrameMainBodyDesc_det_frame,"Cantidad",11,54,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic46 = new ReportText("TEXT_GRAPHIC46",94,306,reportRegionMainBody,116,reportFrameMainBodyDesc_det_frame,"Quantity",11,54,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic47 = new ReportText("TEXT_GRAPHIC47",50,306,reportRegionMainBody,117,reportFrameMainBodyDesc_det_frame,"Unit",11,44,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic49 = new ReportText("TEXT_GRAPHIC49",20,295,reportRegionMainBody,118,reportFrameMainBodyDesc_det_frame,"Item",11,30,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic50 = new ReportText("TEXT_GRAPHIC50",20,306,reportRegionMainBody,119,reportFrameMainBodyDesc_det_frame,"Item",11,30,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,10),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic37 = new ReportText("TEXT_GRAPHIC37",20,413,reportRegionMainBody,82,reportFrameMainBodyFrame_detalle_sin_tot,"Código",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic38 = new ReportText("TEXT_GRAPHIC38",83,413,reportRegionMainBody,83,reportFrameMainBodyFrame_detalle_sin_tot,"Nombre Artículo",9,350,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic39 = new ReportText("TEXT_GRAPHIC39",433,413,reportRegionMainBody,84,reportFrameMainBodyFrame_detalle_sin_tot,"Unidad",9,50,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic40 = new ReportText("TEXT_GRAPHIC40",483,413,reportRegionMainBody,85,reportFrameMainBodyFrame_detalle_sin_tot,"Cantidad",9,52,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic23 = new ReportText("TEXT_GRAPHIC23",20,422,reportRegionMainBody,121,reportFrameMainBodyFrame_detalle_sin_tot,"Code",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic51 = new ReportText("TEXT_GRAPHIC51",83,422,reportRegionMainBody,122,reportFrameMainBodyFrame_detalle_sin_tot,"Item Name",9,350,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic52 = new ReportText("TEXT_GRAPHIC52",433,422,reportRegionMainBody,123,reportFrameMainBodyFrame_detalle_sin_tot,"Unit",9,50,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic53 = new ReportText("TEXT_GRAPHIC53",483,422,reportRegionMainBody,124,reportFrameMainBodyFrame_detalle_sin_tot,"Quantity",9,52,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic3 = new ReportText("TEXT_GRAPHIC3",439,36,reportRegionMainBody,94,reportFrameMainBodyPresentacion,"Quote",14,39,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic2 = new ReportText("TEXT_GRAPHIC2",380,36,reportRegionMainBody,95,reportFrameMainBodyPresentacion,"Cotización /",14,59,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic4 = new ReportText("TEXT_GRAPHIC4",340,50,reportRegionMainBody,96,reportFrameMainBodyPresentacion,"No. &Cot Rev. &Rev",14,174,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic0 = new ReportText("TEXT_GRAPHIC0",20,36,reportRegionMainBody,99,reportFrameMainBodyDatos_cliente,"Señor(es) /",12,55,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic1 = new ReportText("TEXT_GRAPHIC1",75,36,reportRegionMainBody,104,reportFrameMainBodyDatos_cliente,"Mr(s)",12,40,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic41 = new ReportText("TEXT_GRAPHIC41",222,366,reportRegionMainBody,110,reportFrameMainBodyPresupuesto_frame,"Presupuesto /",11,69,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic42 = new ReportText("TEXT_GRAPHIC42",290,366,reportRegionMainBody,111,reportFrameMainBodyPresupuesto_frame,"Budget",11,40,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportLine reportLineMainBodyLine1 = new ReportLine("LINE1",20,284,reportRegionMainBody,92,repetitiveFrameMainBodySecciones_enc,535,286,new Color(0,0,0),null,1,"DEFAULT",false,false,false,null);
