...
public class Cotizaciones_Print_class3 extends Cotizaciones_Print_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic27 = new ReportText("TEXT_GRAPHIC27",0,146,reportRegionMainBody,86,reportFrameMainBodyEncabezado_cot,"Términos de pago /",10,75,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic15 = new ReportText("TEXT_GRAPHIC15",63,233,reportRegionMainBody,45,reportFrameMainBodyDetalle_frame,"Nombre Artículo",9,128,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyTcod = new ReportText("tCod",0,233,reportRegionMainBody,47,reportFrameMainBodyDetalle_frame,"Código Artículo",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
