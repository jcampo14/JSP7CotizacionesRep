...
public class Cotizaciones_Print_class3 extends Cotizaciones_Print_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic27 = new ReportText("TEXT_GRAPHIC27",20,231,reportRegionMainBody,129,reportFrameMainBodyTermino_pago_frame,"Términos de pago /",11,95,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic29 = new ReportText("TEXT_GRAPHIC29",22,624,reportRegionMainBody,74,reportFrameMainBodyFirma,"Comercial Manager",10,255,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic37 = new ReportText("TEXT_GRAPHIC37",20,413,reportRegionMainBody,83,reportFrameMainBodyFrame_detalle_sin_tot,"Código",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic38 = new ReportText("TEXT_GRAPHIC38",83,413,reportRegionMainBody,84,reportFrameMainBodyFrame_detalle_sin_tot,"Nombre Artículo",9,350,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"ALLPAGES",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic2 = new ReportText("TEXT_GRAPHIC2",380,36,reportRegionMainBody,96,reportFrameMainBodyPresentacion,"Cotización /",14,59,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic0 = new ReportText("TEXT_GRAPHIC0",20,36,reportRegionMainBody,100,reportFrameMainBodyDatos_cliente,"Señor(es) /",12,55,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",2,10),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
