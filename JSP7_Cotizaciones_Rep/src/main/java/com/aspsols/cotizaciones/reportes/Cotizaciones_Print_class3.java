...
public class Cotizaciones_Print_class3 extends Cotizaciones_Print_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic14 = new ReportText("TEXT_GRAPHIC14",359,96,reportRegionMainBody,26,reportFrameMainBodyEncabezado_cot,"Currency:",10,37,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic13 = new ReportText("TEXT_GRAPHIC13",322,96,reportRegionMainBody,28,reportFrameMainBodyEncabezado_cot,"Moneda /",10,37,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic16 = new ReportText("TEXT_GRAPHIC16",322,106,reportRegionMainBody,29,reportFrameMainBodyEncabezado_cot,"Destino /",10,36,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic17 = new ReportText("TEXT_GRAPHIC17",358,106,reportRegionMainBody,32,reportFrameMainBodyEncabezado_cot,"Final destination:",10,63,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic25 = new ReportText("TEXT_GRAPHIC25",0,136,reportRegionMainBody,73,reportFrameMainBodyEncabezado_cot,"Despacho /",10,45,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic26 = new ReportText("TEXT_GRAPHIC26",45,136,reportRegionMainBody,74,reportFrameMainBodyEncabezado_cot,"Delivery:",10,34,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic27 = new ReportText("TEXT_GRAPHIC27",0,146,reportRegionMainBody,76,reportFrameMainBodyEncabezado_cot,"Términos de pago /",10,75,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic28 = new ReportText("TEXT_GRAPHIC28",75,146,reportRegionMainBody,77,reportFrameMainBodyEncabezado_cot,"Payment terms:",10,58,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic24 = new ReportText("TEXT_GRAPHIC24",444,242,reportRegionMainBody,37,reportFrameMainBodyDetalle_frame,"Total Price",9,98,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED","TEXT_GRAPHIC24_formatEvent",0,-1);
	protected ReportText reportTextMainBodyText_graphic22 = new ReportText("TEXT_GRAPHIC22",366,242,reportRegionMainBody,38,reportFrameMainBodyDetalle_frame,"Unit. Price",9,78,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED","TEXT_GRAPHIC22_formatEvent",0,-1);
	protected ReportText reportTextMainBodyText_graphic21 = new ReportText("TEXT_GRAPHIC21",238,242,reportRegionMainBody,39,reportFrameMainBodyDetalle_frame,"Quantity",9,60,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic20 = new ReportText("TEXT_GRAPHIC20",191,242,reportRegionMainBody,40,reportFrameMainBodyDetalle_frame,"Unit",9,47,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic23 = new ReportText("TEXT_GRAPHIC23",298,242,reportRegionMainBody,41,reportFrameMainBodyDetalle_frame,"IVA",9,68,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic19 = new ReportText("TEXT_GRAPHIC19",63,242,reportRegionMainBody,42,reportFrameMainBodyDetalle_frame,"Item Name",9,128,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic18 = new ReportText("TEXT_GRAPHIC18",0,242,reportRegionMainBody,43,reportFrameMainBodyDetalle_frame,"Item Code",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",2,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic15 = new ReportText("TEXT_GRAPHIC15",63,233,reportRegionMainBody,44,reportFrameMainBodyDetalle_frame,"Nombre Artículo",9,128,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyTsubtotal = new ReportText("tSubtotal",444,233,reportRegionMainBody,45,reportFrameMainBodyDetalle_frame,"Subtotal",9,98,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED","tSubtotal_formatEvent",0,-1);
	protected ReportText reportTextMainBodyTcod = new ReportText("tCod",0,233,reportRegionMainBody,46,reportFrameMainBodyDetalle_frame,"Código Artículo",9,63,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyTcantidad = new ReportText("tCantidad",238,233,reportRegionMainBody,47,reportFrameMainBodyDetalle_frame,"Cantidad",9,60,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyTunidad = new ReportText("tUnidad",191,233,reportRegionMainBody,48,reportFrameMainBodyDetalle_frame,"Unidad",9,47,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyT_ven1 = new ReportText("t_VEN1",366,233,reportRegionMainBody,49,reportFrameMainBodyDetalle_frame,"Precio Venta",9,78,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED","t_VEN1_formatEvent",0,-1);
	protected ReportText reportTextMainBodyT_iva1 = new ReportText("t_IVA1",298,233,reportRegionMainBody,50,reportFrameMainBodyDetalle_frame,"IVA",9,68,new Color(0,0,0),new Color(204,204,204),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic29 = new ReportText("TEXT_GRAPHIC29",44,438,reportRegionMainBody,95,reportFrameMainBodyFirma,"Comercial",10,255,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,8),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	protected ReportText reportTextMainBodyText_graphic30 = new ReportText("TEXT_GRAPHIC30",44,458,reportRegionMainBody,96,reportFrameMainBodyFirma,"Elab. NM",10,255,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,7),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportLine reportLineMainBodyLine_enc1 = new ReportLine("LINE_ENC1",0,96,reportRegionMainBody,97,reportFrameMainBodyEncabezado_cot,542,97,new Color(0,0,0),null,1,"DEFAULT",false,false,false,null);
	protected ReportLine reportLineMainBodyLine_enc2 = new ReportLine("LINE_ENC2",0,156,reportRegionMainBody,98,reportFrameMainBodyEncabezado_cot,542,157,new Color(0,0,0),null,1,"DEFAULT",false,false,false,null);
	protected ReportLine reportLineMainBodyLine_sec_enc = new ReportLine("LINE_SEC_ENC",0,195,reportRegionMainBody,99,reportFrameMainBodySecciones_enc_frame,542,196,new Color(0,0,0),null,1,"DEFAULT",false,false,false,null);
