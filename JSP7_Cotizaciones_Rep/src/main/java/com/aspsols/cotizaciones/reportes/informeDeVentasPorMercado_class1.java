...
public class informeDeVentasPorMercado_class1 extends JReportRuntime {
	...
	protected Query queryQUERY0 = new Query("QUERY0","MASTER","WHERE SUBSTR(VXJ.MES_ACTUAL, 1 , 6 ) = #periodo AND C_EMP = #empresa",null,"ORDER BY VXJ.ZON"," SELECT  VXJ.ZON   ,VXJ.NOM   ,VXJ.MON   ,VXJ.MES_ACTUAL   , ROUND (VXJ.VENTAS_ACTUAL, 0 )  VENTAS_ACTUAL  ,VXJ.MES_PASADO   , ROUND (VXJ.VENTAS_PASADAS)  VENTAS_PASADAS   FROM VENTAS_XMERCADO_JOIN VXJ  WHERE SUBSTR(VXJ.MES_ACTUAL, 1 , 6 ) = #periodo AND C_EMP = #empresa",null);
	...
	protected GroupField groupFieldGROUP0NOM = new GroupField("NOM",1,"java.lang.String",null,null,"ASC",null,null,"REPORT","REPORT",null,"DATABASE",null,false,0,groupGROUP0,this);
	protected GroupField groupFieldGROUP0MES_ACTUAL = new GroupField("MES_ACTUAL",3,"java.lang.String",null,null,"ASC",null,null,"REPORT","REPORT",null,"DATABASE",null,false,0,groupGROUP0,this);
	protected GroupField groupFieldGROUP0MES_PASADO = new GroupField("MES_PASADO",5,"java.lang.String",null,null,"ASC",null,null,"REPORT","REPORT",null,"DATABASE",null,false,0,groupGROUP0,this);
	protected GroupField groupFieldGROUP0VENTAS_ACTUAL = new GroupField("VENTAS_ACTUAL",4,"java.lang.String","0",null,"ASC",null,null,"REPORT","REPORT",null,"DATABASE",null,false,0,groupGROUP0,this);
	protected GroupField groupFieldGROUP0VENTAS_PASADAS = new GroupField("VENTAS_PASADAS",6,"java.lang.String","0",null,"ASC",null,null,"REPORT","REPORT",null,"DATABASE",null,false,0,groupGROUP0,this);
