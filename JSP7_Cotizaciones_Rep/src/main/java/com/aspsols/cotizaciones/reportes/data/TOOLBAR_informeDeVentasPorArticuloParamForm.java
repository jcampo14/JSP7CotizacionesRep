...
public class TOOLBAR_informeDeVentasPorArticuloParamForm extends ApplicationDataServer implements IAcceptJForm {
	/**
	 * default serial ID. 
	 */
	...
	public TOOLBAR_informeDeVentasPorArticuloParamForm (){
	}
