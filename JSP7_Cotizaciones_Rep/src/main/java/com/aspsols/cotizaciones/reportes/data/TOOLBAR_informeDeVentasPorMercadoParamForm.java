...
public class TOOLBAR_informeDeVentasPorMercadoParamForm extends ApplicationDataServer implements IAcceptJForm {
	/**
	 * default serial ID. 
	 */
	...
	public TOOLBAR_informeDeVentasPorMercadoParamForm (){
	}
