...
public class Cotizaciones_Print_class2 extends Cotizaciones_Print_class1 {
	protected ReportFrame reportFrameMainBodyFrame0 = new ReportFrame("FRAME0",0,0,669,548,reportRegionMainBody,0,null,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyEncabezado = new ReportRepetitiveFrame("ENCABEZADO",0,0,657,548,reportRegionMainBody,1,reportFrameMainBodyFrame0,"FIXED","EXPAND","GROUP_ENCABEZADO","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyEncabezado_cot = new ReportFrame("ENCABEZADO_COT",0,151,83,548,reportRegionMainBody,2,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyNombres_cargos = new ReportRepetitiveFrame("NOMBRES_CARGOS",375,184,11,173,reportRegionMainBody,82,reportFrameMainBodyEncabezado_cot,"FIXED","VARIABLE","COSTOS_ADIC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyTermino_pago_frame = new ReportFrame("TERMINO_PAGO_FRAME",0,206,13,548,reportRegionMainBody,130,reportFrameMainBodyEncabezado_cot,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pre = new ReportRepetitiveFrame("SECCIONES_PRE",0,133,15,548,reportRegionMainBody,20,repetitiveFrameMainBodyEncabezado,"FIXED","VARIABLE","SECCIONES_PRE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyDetalle_frame = new ReportFrame("DETALLE_FRAME",0,370,31,548,reportRegionMainBody,24,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,"DETALLE_FRAME_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDetalle = new ReportRepetitiveFrame("DETALLE",20,390,11,500,reportRegionMainBody,25,reportFrameMainBodyDetalle_frame,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"DETALLE_formatEvent",0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyTotales = new ReportFrame("TOTALES",0,450,65,548,reportRegionMainBody,44,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyCostos_adicionales = new ReportRepetitiveFrame("COSTOS_ADICIONALES",302,495,9,218,reportRegionMainBody,72,reportFrameMainBodyTotales,"FIXED","VARIABLE","COSTOS_ADIC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_enc_frame = new ReportFrame("SECCIONES_ENC_FRAME",0,246,34,548,reportRegionMainBody,51,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_enc = new ReportRepetitiveFrame("SECCIONES_ENC",20,246,34,500,reportRegionMainBody,52,reportFrameMainBodySecciones_enc_frame,"FIXED","VARIABLE","SECCIONES_ENC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_pie_frame = new ReportFrame("SECCIONES_PIE_FRAME",0,537,29,548,reportRegionMainBody,55,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pie = new ReportRepetitiveFrame("SECCIONES_PIE",20,537,29,500,reportRegionMainBody,56,reportFrameMainBodySecciones_pie_frame,"FIXED","VARIABLE","SECCIONES_PIE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyDesc_det_frame = new ReportFrame("DESC_DET_FRAME",0,287,62,548,reportRegionMainBody,62,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDesc_det = new ReportRepetitiveFrame("DESC_DET",20,313,34,500,reportRegionMainBody,63,reportFrameMainBodyDesc_det_frame,"FIXED","VARIABLE","DESCRIPCIONES_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyFirma = new ReportFrame("FIRMA",0,577,30,548,reportRegionMainBody,75,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyFrame_detalle_sin_tot = new ReportFrame("FRAME_DETALLE_SIN_TOT",0,401,31,548,reportRegionMainBody,86,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,"FRAME_DETALLE_SIN_TOT_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySt_detalle = new ReportRepetitiveFrame("ST_DETALLE",20,419,11,500,reportRegionMainBody,91,reportFrameMainBodyFrame_detalle_sin_tot,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"ST_DETALLE_formatEvent",0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyPresentacion = new ReportFrame("PRESENTACION",0,4,126,548,reportRegionMainBody,98,repetitiveFrameMainBodyEncabezado,"FIXED","VARIABLE",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyDatos_cliente = new ReportFrame("DATOS_CLIENTE",20,36,90,175,reportRegionMainBody,102,reportFrameMainBodyPresentacion,"FIXED","VARIABLE",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyPresupuesto_frame = new ReportFrame("PRESUPUESTO_FRAME",0,356,11,548,reportRegionMainBody,114,repetitiveFrameMainBodyEncabezado,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainMarginReserva_derechos = new ReportFrame("RESERVA_DERECHOS",34,749,20,544,reportRegionMainMargin,2,null,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
