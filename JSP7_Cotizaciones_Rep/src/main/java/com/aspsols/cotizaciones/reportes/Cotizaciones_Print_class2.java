...
public class Cotizaciones_Print_class2 extends Cotizaciones_Print_class1 {
	...
	protected ReportFrame reportFrameMainBodyDatos_cliente = new ReportFrame("DATOS_CLIENTE",22,4,80,175,reportRegionMainBody,2,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyEncabezado_cot = new ReportFrame("ENCABEZADO_COT",0,107,63,542,reportRegionMainBody,10,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyNombres_cargos = new ReportRepetitiveFrame("NOMBRES_CARGOS",389,137,10,153,reportRegionMainBody,99,reportFrameMainBodyEncabezado_cot,"FIXED","VARIABLE","COSTOS_ADIC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pre = new ReportRepetitiveFrame("SECCIONES_PRE",0,87,15,542,reportRegionMainBody,31,repetitiveFrameMainBodyEncabezado,"FIXED","VARIABLE","SECCIONES_PRE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyDetalle_frame = new ReportFrame("DETALLE_FRAME",0,254,31,542,reportRegionMainBody,35,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"ALLPAGES",false,false,false,"DETALLE_FRAME_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDetalle = new ReportRepetitiveFrame("DETALLE",22,274,11,496,reportRegionMainBody,36,reportFrameMainBodyDetalle_frame,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"DETALLE_formatEvent",0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyTotales = new ReportFrame("TOTALES",0,319,65,542,reportRegionMainBody,58,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyCostos_adicionales = new ReportRepetitiveFrame("COSTOS_ADICIONALES",300,364,9,218,reportRegionMainBody,86,reportFrameMainBodyTotales,"FIXED","VARIABLE","COSTOS_ADIC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_enc_frame = new ReportFrame("SECCIONES_ENC_FRAME",0,178,29,542,reportRegionMainBody,65,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_enc = new ReportRepetitiveFrame("SECCIONES_ENC",22,178,29,496,reportRegionMainBody,66,reportFrameMainBodySecciones_enc_frame,"FIXED","VARIABLE","SECCIONES_ENC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_pie_frame = new ReportFrame("SECCIONES_PIE_FRAME",0,410,29,542,reportRegionMainBody,69,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pie = new ReportRepetitiveFrame("SECCIONES_PIE",22,410,29,496,reportRegionMainBody,70,reportFrameMainBodySecciones_pie_frame,"FIXED","VARIABLE","SECCIONES_PIE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyDesc_det_frame = new ReportFrame("DESC_DET_FRAME",0,210,29,542,reportRegionMainBody,76,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDesc_det = new ReportRepetitiveFrame("DESC_DET",22,210,29,496,reportRegionMainBody,77,reportFrameMainBodyDesc_det_frame,"FIXED","VARIABLE","DESCRIPCIONES_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"DESC_DET_formatEvent",0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyFirma = new ReportFrame("FIRMA",0,555,30,542,reportRegionMainBody,89,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyFrame_detalle_sin_tot = new ReportFrame("FRAME_DETALLE_SIN_TOT",0,285,31,542,reportRegionMainBody,106,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,"FRAME_DETALLE_SIN_TOT_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySt_detalle = new ReportRepetitiveFrame("ST_DETALLE",22,296,11,496,reportRegionMainBody,111,reportFrameMainBodyFrame_detalle_sin_tot,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
