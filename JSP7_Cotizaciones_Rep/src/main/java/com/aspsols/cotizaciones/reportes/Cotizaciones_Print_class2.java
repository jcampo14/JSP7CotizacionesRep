...
public class Cotizaciones_Print_class2 extends Cotizaciones_Print_class1 {
	...
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pre = new ReportRepetitiveFrame("SECCIONES_PRE",0,72,15,542,reportRegionMainBody,32,repetitiveFrameMainBodyEncabezado,"FIXED","FIXED","SECCIONES_PRE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyDetalle_frame = new ReportFrame("DETALLE_FRAME",0,201,31,542,reportRegionMainBody,36,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDetalle = new ReportRepetitiveFrame("DETALLE",0,221,11,542,reportRegionMainBody,37,reportFrameMainBodyDetalle_frame,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"DETALLE_formatEvent",0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyTotales = new ReportFrame("TOTALES",0,234,63,542,reportRegionMainBody,59,repetitiveFrameMainBodyEncabezado,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_enc_frame = new ReportFrame("SECCIONES_ENC_FRAME",0,165,29,542,reportRegionMainBody,75,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_enc = new ReportRepetitiveFrame("SECCIONES_ENC",86,165,29,359,reportRegionMainBody,76,reportFrameMainBodySecciones_enc_frame,"FIXED","EXPAND","SECCIONES_ENC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyFrame1 = new ReportFrame("FRAME1",0,306,29,542,reportRegionMainBody,79,repetitiveFrameMainBodyEncabezado,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pie = new ReportRepetitiveFrame("SECCIONES_PIE",86,306,29,359,reportRegionMainBody,80,reportFrameMainBodyFrame1,"FIXED","FIXED","SECCIONES_PIE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
