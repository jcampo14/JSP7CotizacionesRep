...
public class Cotizaciones_Print_class2 extends Cotizaciones_Print_class1 {
	...
	protected ReportFrame reportFrameMainBodyDetalle_frame = new ReportFrame("DETALLE_FRAME",0,386,31,548,reportRegionMainBody,24,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,"DETALLE_FRAME_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDetalle = new ReportRepetitiveFrame("DETALLE",20,406,11,515,reportRegionMainBody,25,reportFrameMainBodyDetalle_frame,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"DETALLE_formatEvent",0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodyTotales = new ReportFrame("TOTALES",0,453,65,548,reportRegionMainBody,44,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyCostos_adicionales = new ReportRepetitiveFrame("COSTOS_ADICIONALES",282,490,9,253,reportRegionMainBody,67,reportFrameMainBodyTotales,"FIXED","VARIABLE","COSTOS_ADIC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,0,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_enc_frame = new ReportFrame("SECCIONES_ENC_FRAME",0,264,34,548,reportRegionMainBody,49,repetitiveFrameMainBodyEncabezado,"FIXED","VARIABLE",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_enc = new ReportRepetitiveFrame("SECCIONES_ENC",20,264,34,515,reportRegionMainBody,50,reportFrameMainBodySecciones_enc_frame,"FIXED","VARIABLE","SECCIONES_ENC","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodySecciones_pie_frame = new ReportFrame("SECCIONES_PIE_FRAME",0,524,29,548,reportRegionMainBody,53,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySecciones_pie = new ReportRepetitiveFrame("SECCIONES_PIE",20,524,29,515,reportRegionMainBody,54,reportFrameMainBodySecciones_pie_frame,"FIXED","VARIABLE","SECCIONES_PIE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	protected ReportFrame reportFrameMainBodyDesc_det_frame = new ReportFrame("DESC_DET_FRAME",0,299,62,548,reportRegionMainBody,59,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodyDesc_det = new ReportRepetitiveFrame("DESC_DET",20,325,34,515,reportRegionMainBody,60,reportFrameMainBodyDesc_det_frame,"FIXED","VARIABLE","DESCRIPCIONES_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,null,0,5,0,-1,false);
	...
	protected ReportFrame reportFrameMainBodyFrame_detalle_sin_tot = new ReportFrame("FRAME_DETALLE_SIN_TOT",0,417,31,548,reportRegionMainBody,80,repetitiveFrameMainBodyEncabezado,"FIXED","EXPAND",new Color(255,255,255),null,"DEFAULT",false,false,false,"FRAME_DETALLE_SIN_TOT_formatEvent",0,-1,false);
	protected ReportRepetitiveFrame repetitiveFrameMainBodySt_detalle = new ReportRepetitiveFrame("ST_DETALLE",20,435,11,515,reportRegionMainBody,85,reportFrameMainBodyFrame_detalle_sin_tot,"FIXED","EXPAND","GROUP_DETALLE","Down",new Color(255,255,255),null,0,"DEFAULT",false,false,false,"ST_DETALLE_formatEvent",0,0,0,-1,false);
	...
	protected ReportFrame reportFrameMainBodyFrame_cont_presp = new ReportFrame("FRAME_CONT_PRESP",0,361,20,548,reportRegionMainBody,125,repetitiveFrameMainBodyEncabezado,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
	protected ReportFrame reportFrameMainBodyPresupuesto_frame = new ReportFrame("PRESUPUESTO_FRAME",0,370,11,548,reportRegionMainBody,126,reportFrameMainBodyFrame_cont_presp,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false,null,0,-1,false);
