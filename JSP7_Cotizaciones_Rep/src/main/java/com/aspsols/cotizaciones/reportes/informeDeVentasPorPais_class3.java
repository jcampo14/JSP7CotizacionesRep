...
public class informeDeVentasPorPais_class3 extends informeDeVentasPorPais_class2 {
	...
	protected ReportText reportTextMainBodyText_graphic6 = new ReportText("TEXT_GRAPHIC6",440,2,reportRegionMainBody,16,reportFrameMainBodyFrame1,"%",10,84,new Color(255,255,255),new Color(226,107,10),null,new Font("Arial",1,8),"DEFAULT",false,false,true,false,0,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainBodyText_graphic7 = new ReportText("TEXT_GRAPHIC7",172,36,reportRegionMainBody,24,reportFrameMainBodyFrame3,"Grafico de ventas por pais por periodo en &mon",11,277,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",0,9),"DEFAULT",false,false,false,false,2,"FIXED","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainMarginText_graphic0 = new ReportText("TEXT_GRAPHIC0",223,22,reportRegionMainMargin,2,null,"Informe de ventas por pais del mes &mes del año &periodo_act con respecto al año anterior",21,349,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,9),"DEFAULT",false,false,false,false,4,"EXPAND","FIXED",null,0,-1);
	...
	protected ReportText reportTextMainMarginText_graphic2 = new ReportText("TEXT_GRAPHIC2",481,54,reportRegionMainMargin,5,null,"Página",9,41,new Color(0,0,0),new Color(255,255,255),null,new Font("Arial",1,8),"DEFAULT",false,false,false,false,4,"FIXED","FIXED",null,0,-1);
	...
	protected ReportChart reportChartMainBodyLayout_chart0 = new ReportChart("LAYOUT_CHART0",31,47,115,487,reportRegionMainBody,23,reportFrameMainBodyFrame3,"FIXED","FIXED",new Color(255,255,255),null,"DEFAULT",false,false,false);
